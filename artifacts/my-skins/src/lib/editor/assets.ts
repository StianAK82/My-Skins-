...
const AVATAR_BASE_MODELS: AvatarBaseModel[] = [
  {
    ...
    bodyParts: [
      { id: "head", primitive: "roundedBox", args: [0.78, 0.7, 0.66], position: [0, 2.02, 0], radius: 0.08, smoothness: 6, material: "skin" },
      { id: "neck", primitive: "roundedBox", args: [0.3, 0.1, 0.3], position: [0, 1.66, 0], radius: 0.04, smoothness: 4, material: "skin" },
      { id: "torso", primitive: "roundedBox", args: [1.0, 1.0, 0.5], position: [0, 1.12, 0], radius: 0.06, smoothness: 6, material: "shirt" },
      { id: "leftUpperArm", primitive: "roundedBox", args: [0.46, 0.92, 0.46], position: [-0.73, 1.16, 0], radius: 0.07, smoothness: 5, material: "shirt" },
      { id: "rightUpperArm", primitive: "roundedBox", args: [0.46, 0.92, 0.46], position: [0.73, 1.16, 0], radius: 0.07, smoothness: 5, material: "shirt" },
      { id: "leftHand", primitive: "roundedBox", args: [0.44, 0.18, 0.46], position: [-0.73, 0.62, 0], radius: 0.05, smoothness: 5, material: "skin" },
      { id: "rightHand", primitive: "roundedBox", args: [0.44, 0.18, 0.46], position: [0.73, 0.62, 0], radius: 0.05, smoothness: 5, material: "skin" },
      { id: "leftLeg", primitive: "roundedBox", args: [0.48, 1.06, 0.5], position: [-0.25, 0.53, 0], radius: 0.05, smoothness: 5, material: "pants" },
      { id: "rightLeg", primitive: "roundedBox", args: [0.48, 1.06, 0.5], position: [0.25, 0.53, 0], radius: 0.05, smoothness: 5, material: "pants" },
    ],
  },
  {
    id: "proportioned_r15",
    ...
    bodyParts: [
      { id: "head", primitive: "roundedBox", args: [0.63, 0.62, 0.58], position: [0, 2.02, 0], radius: 0.14, smoothness: 7, material: "skin" },
      { id: "neck", primitive: "roundedBox", args: [0.22, 0.11, 0.22], position: [0, 1.69, 0], radius: 0.05, smoothness: 5, material: "skin" },
      { id: "upperTorso", primitive: "roundedBox", args: [0.9, 0.56, 0.5], position: [0, 1.41, 0], radius: 0.12, smoothness: 8, material: "shirt" },
      { id: "lowerTorso", primitive: "roundedBox", args: [0.84, 0.38, 0.5], position: [0, 1.02, 0], radius: 0.1, smoothness: 7, material: "pants" },
      { id: "leftUpperArm", primitive: "roundedBox", args: [0.28, 0.44, 0.28], position: [-0.58, 1.42, 0], radius: 0.1, smoothness: 7, material: "shirt" },
      { id: "rightUpperArm", primitive: "roundedBox", args: [0.28, 0.44, 0.28], position: [0.58, 1.42, 0], radius: 0.1, smoothness: 7, material: "shirt" },
      { id: "leftLowerArm", primitive: "roundedBox", args: [0.24, 0.4, 0.24], position: [-0.58, 1.0, 0], radius: 0.09, smoothness: 7, material: "shirt" },
      { id: "rightLowerArm", primitive: "roundedBox", args: [0.24, 0.4, 0.24], position: [0.58, 1.0, 0], radius: 0.09, smoothness: 7, material: "shirt" },
      { id: "leftHand", primitive: "roundedBox", args: [0.24, 0.2, 0.24], position: [-0.58, 0.72, 0], radius: 0.08, smoothness: 6, material: "skin" },
      { id: "rightHand", primitive: "roundedBox", args: [0.24, 0.2, 0.24], position: [0.58, 0.72, 0], radius: 0.08, smoothness: 6, material: "skin" },
      { id: "leftUpperLeg", primitive: "roundedBox", args: [0.33, 0.5, 0.34], position: [-0.22, 0.64, 0], radius: 0.09, smoothness: 7, material: "pants" },
      { id: "rightUpperLeg", primitive: "roundedBox", args: [0.33, 0.5, 0.34], position: [0.22, 0.64, 0], radius: 0.09, smoothness: 7, material: "pants" },
      { id: "leftLowerLeg", primitive: "roundedBox", args: [0.31, 0.48, 0.32], position: [-0.22, 0.2, 0], radius: 0.09, smoothness: 7, material: "pants" },
      { id: "rightLowerLeg", primitive: "roundedBox", args: [0.31, 0.48, 0.32], position: [0.22, 0.2, 0], radius: 0.09, smoothness: 7, material: "pants" },
    ],
  },
  {
    id: "heroic",
