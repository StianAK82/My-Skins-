...
> = {
  ...
  blazer: ["lapels", "structured_shoulders", "front_opening", "buttons"],
  suit_jacket: ["lapels", "structured_shoulders", "front_opening", "buttons"],
  puffer_jacket: ["quilt_sections", "inflated_volume", "thick_sleeves"],
  winter_coat: ["quilt_sections", "inflated_volume", "thick_sleeves"],
  cargo_pants: ["side_pockets", "relaxed_fit", "seam_placement"],
  shoes: ["sole", "heel", "toe_box", "tongue", "laces"],
  long_hair: ["silhouette", "strands", "front_volume", "back_volume"],
  short_hair: ["silhouette", "strands", "front_volume", "back_volume"],
  curly_hair: ["silhouette", "strands", "front_volume", "back_volume"],
  afro_hair: ["silhouette", "strands", "front_volume", "back_volume"],
  dreadlocks: ["silhouette", "strands", "front_volume", "back_volume"],
  ponytail_hair: ["silhouette", "strands", "front_volume", "back_volume"],
  anime_hair: ["silhouette", "strands", "front_volume", "back_volume"],
  roblox_hair: ["silhouette", "strands", "front_volume", "back_volume"],
};
