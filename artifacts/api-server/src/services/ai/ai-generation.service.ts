...
export class AiGenerationService {
  private buildPrompt(input: GenerateInput, mode: string): string {
    ...
    return [
      ...
      '    "accessories": [{"kind": "cap|beanie|hat|helmet|crown|glasses|mask|wings|backpack|bag|necklace|scarf|horns|tail|belt|gloves|unicorn_horn|dragon_hood", "color": "#RRGGBB"}],',
      '    "unsupported": ["string"],',
      '    "reason": "string"',
      "  }",
      "}",
