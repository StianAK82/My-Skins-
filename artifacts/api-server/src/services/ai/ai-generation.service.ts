...
export class AiGenerationService {
  private buildPrompt(input: GenerateInput, mode: string): string {
    ...
    return [
      ...
      '    "customParts": [{"name": "string", "shape": "horn|spike|orb|plate|band|snake|fin|blob", "attach": "forehead|head_top|face|neck|chest|belly|back|hips|left_shoulder|right_shoulder|left_hand|right_hand|left_leg|right_leg|left_foot|right_foot", "color": "#RRGGBB", "size": "small|medium|large"}],',
      '    "unsupported": ["string"],',
      '    "reason": "string"',
      "  }",
      "}",
