...
export class AiGenerationService {
  private buildPrompt(input: GenerateInput, mode: string): string {
    ...
    return [
      ...
      "Norwegian 'dress' and 'smoking' are SUITS (jacket+pants) — NEVER the gown garment top=dress. Only kjole/gown/ballkjole/prinsessekjole means top=dress. Vest=jacket (slim, sleeveless look), singlet/tanktop=tshirt (sleeveless look) — these ARE supported, never put common garments in `unsupported`.",
